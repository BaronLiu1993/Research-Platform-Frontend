      ...
      <Breadcrumb className="font-main font-semibold flex flex-wrap sm:flex-nowrap h-8 items-center gap-2 px-4 sm:px-6 py-2">
        <BreadcrumbList>
          <BreadcrumbItem className="hidden md:flex">
            ...
            >
              <Laptop className="rounded-xs h-5 w-5 text-black" />
              Home
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator>
          ...
          <BreadcrumbItem>
            <BreadcrumbPage className="font-main flex items-center gap-2 font-medium text-xs text-[#37352F] hover:underline cursor-pointer">
              <LockKeyhole className="text-black h-4 w-4" />
              Sign Up
            </BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
