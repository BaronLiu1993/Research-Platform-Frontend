        ...
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbPage className="font-main flex items-center gap-2 font-medium text-[#37352F]">
              <Blocks className="rounded-xs text-white fill-blue-700 h-5 w-5" />
              Builder
            </BreadcrumbPage>
          </BreadcrumbItem>
          <BreadcrumbSeparator>
          ...
          <BreadcrumbItem>
            <BreadcrumbPage className="font-main flex items-center gap-2 font-medium text-[#37352F]">
              <LockKeyholeIcon className="rounded-xs text-white fill-blue-700 h-5 w-5" />
              Builder
            </BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      ...
      <div className="w-full mt-30 flex flex-col space-y-10 justify-center items-center font-main">
        ...
        <div>
          <p className="font-light text-xs w-[30rem] text-center">
            By clicking "Connect with Notion" above, you acknowledge that you
            have read, understood and agree to the{" "}
            <span className="font-semibold">Terms and Conditions</span> and{" "}
            <span className="font-semibold">Privacy Policy</span> as applicable
            to your use.
          </p>
        </div>
      </div>
