...
import { Laptop, Newspaper } from "lucide-react";
    ...
    <>
      ...
      <main className="bg-white text-gray-900 font-main px-7 py-12 leading-relaxed flex flex-col justify-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-md mb-5">
            We are (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;,
            &quot;our&quot;).
          </p>

          <p className="text-md mb-5">
            We operate this website and related services, as well as any other
            related products and services that refer or link to these legal
            terms (the <strong>&quot;Legal Terms&quot;</strong>) (collectively,
            the <strong>&quot;Services&quot;</strong>).
          </p>

          <p className="text-md mb-5">
            You can contact us by email at jiexuan55@gmail.com.
          </p>

          <p className="text-md mb-5">
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity
            (&quot;you&quot;), and the operator of the Services, concerning your
      ...
      <section className="bg-white text-gray-900 font-main px-7 py-12 leading-relaxed flex flex-col justify-center">
        <div className="max-w-5xl mx-auto">
          ...
          <ul className="list-disc pl-6 text-md mb-5 space-y-2">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <ul className="list-disc pl-6 text-md mb-5 space-y-2">
            ...
            <li>
              warrant that any such Submissions are original to you or that you
      ...
      <section className="bg-white text-gray-900 font-main px-7 py-12 leading-relaxed flex flex-col justify-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-md">
            ...
            laws of <strong>Canada</strong> and the laws of the{" "}
            <strong>Province of Ontario</strong>. You irrevocably consent that
            the courts of the Province of Ontario, Canada, shall have exclusive
      ...
      <section className="bg-white text-gray-900 font-main px-7 py-12 leading-relaxed flex flex-col justify-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-md mb-10">
            ...
            US OR CAD $100. CERTAIN PROVINCIAL LAWS IN CANADA DO NOT ALLOW
