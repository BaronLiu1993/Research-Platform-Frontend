    ...
    <>
      <div className="flex justify-center items-center">
        <div>
          <div className="h-[5rem] w-[10rem] flex flex-col justify-center items-center border-2 border-gray-300 cursor-pointer border-dashed rounded-md">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <h1 className="font-sans font-sm text-sm">
        ...
        <div className="font-sans m-10">
          <h1 className="font-sans font-sm text-sm">
            Email: Jiexuan.liu@mail.utoronto.ca
          </h1>
          <div className="text-xs">
            ...
            <div className="mt-5">
              <h1>Body: </h1>
              <p>
                Dear Professor [Last Name], I hope you're doing well. My name is
                [Your Name], a student in [Your Program] at UofT. I’m very
                interested in your research on [Specific Topic] and would love
                to learn more. I am currently working on [Brief Project
                Description] and believe your insights in [Research Area] would
                be valuable. Would you be available for a brief meeting or call
                to discuss your work and potential collaboration? Looking
