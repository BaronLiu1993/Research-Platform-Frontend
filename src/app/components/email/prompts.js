export const emailPrompts = [
  {
    level: "beginner",
    description:
      "You're new to research with no direct experience, but you're eager to learn and get involved.",
  ...
  },
  {
    level: "intermediate",
    description:
      "You have some relevant coursework or project experience and want to build a connection.",
    body: `Dear [Recipient Name],
  ...
  },
  {
    level: "advanced",
    description:
      "You have strong domain knowledge, research experience, or publications and want to explore collaboration.",
    body: `Dear [Recipient Name],
