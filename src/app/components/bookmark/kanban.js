...
export default async function Kanban({ userId, parsedSavedData, parsedInProgressData, parsedCompletedData, draftData, parsedUserProfile, parsedResumeData, parsedTranscriptData}) {
    ...
    <div className="flex flex-col h-fit font-main overflow-hidden">
      ...
      <Tabs defaultValue="table">
        ...
        <TabsContent value="table">
          <SavedDataTable parsedTranscriptData = {parsedTranscriptData} parsedResumeData ={parsedResumeData} parsedUserProfile = {parsedUserProfile} data = {columnsData[0].data} columns = {SavedColumns} draftData = {draftData} parsedCompletedData = {parsedCompletedData} userId = {userId} parsedInProgressData = {parsedInProgressData} />
        </TabsContent>
