  ...
  const MentionList = forwardRef((props, ref) => {
    ...
    return (
      <div
        ...
        className="rounded-sm border py-3 px-1 bg-white w-[360px] max-h-[300px] overflow-y-auto"
      >
          ...
          {props.items.length ? (
            <>
              ...
              {props.items.map((item, index) => (
                <button
                  className={`flex font-main gap-2 min-w-full items-center p-2 rounded-xs hover:cursor-pointer hover:bg-gray-100 ${
